def neb_identify_local_minima(filename="last_predicted_path.traj"):
    ...
    '''
    This function will detect local minima in the last_predicted_path.traj of
    the ML-NEB calculation and will output the associated structures and their
    their index.
    The user can then optimise these and use as an alternative starting
