...
# Fix all atoms below the mean height of the slab
...
neb_catlearn = MLNEB(start=images_ase[0], #'initial.traj',
                     end=images_ase[-1], #'final.traj',
                     ase_calc=EMT(),
                     n_images=n_images,
