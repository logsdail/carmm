...
def test_file_stitch():
    ...
    with open('data/H+CH4_CH3+H2_path/H+CH4_CH3+H2_stitched.xyz', 'r') as test:
        ...
        assert lines[2] == '   C   0.63304144726145573 -0.1087864399671382 -0.56719035628535563   1'
        assert lines[8] == '6'
        assert lines[9] == 'Frame 1'
        assert lines[10] == '   C   0.88562473811384212 0.97416578530588571 1.0453399509875991   1'
