...
def test_analyse_mulliken_charge():
    ...
    # The filename needed is the FHI-aims output file (e.g. aims.out, fhiaims.hawk.output.log.XXXXXXX, etc.)
    # Have a look in the file named below if unsure, so you can see the example contents yourself!
